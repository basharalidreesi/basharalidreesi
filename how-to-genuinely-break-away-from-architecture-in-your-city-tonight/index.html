...
<html>
  <body>
	  This is generated from default.html
    <p>This is genrated from Power and the Displays of an Enthroned Prince</p>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<body>
	...
	<h1 class="text headingtext threequarterwidthtext centredtext secondaryfonttext threequarterwidthtext">
		How to genuinely Break Away from Architecture (In Your City Tonight), Bashar al-Idreesi
	</h1>
